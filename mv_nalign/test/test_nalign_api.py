import pytest
from mv_nalign import app as mv_app
# from mv_nalign.models.loyalties import *
import sys
from os import path
...
#files = {'file_metadata': open('mv_nalign/media/d29347da23e04b5eb35ff3dc7192cdb2_frame_0.jpg','rb')}
upload_payload = {
