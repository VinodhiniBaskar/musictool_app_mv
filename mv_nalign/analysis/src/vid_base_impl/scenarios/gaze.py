import asyncio
import mv_nalign.analysis.src.gaze.analyzer as ga
from mv_nalign.analysis.src.gaze.analyzer import GazeResult
from mv_nalign.analysis.src.gaze.cnn import create_detector
from mv_nalign.analysis.src.file_type_helper import get_type
from mv_nalign.analysis.src.async_tools import thread_pool
import mv_nalign.analysis.src.aws.provider as pr
from mv_nalign.analysis.src.gaze.provider import AwsImageFacesProvider, AwsVideoFacesProvider
...
class Gaze:
    ...
    @thread_pool
    def get_analyzer_result(self, analyzer, faces_provider):
        gaze_ts = analyzer.get_gaze_results(faces_provider)
        result = []
        result_group = None
